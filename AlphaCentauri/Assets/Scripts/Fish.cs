...
public class FishGenerator
{
    ...
    public static readonly Dictionary<FishType, FishTemplate> FishTemplates = new Dictionary<FishType, FishTemplate>{
        ...
        {FishType.KingCrab, new FishTemplate(FishType.KingCrab,"KingCrab", Fish.FishRarity.Rare, 150, 200, 1.8f, 2, 60, 6000, Resources.Load("Images/Fish/KingCrab.png")as Sprite)},
        {FishType.Eel, new FishTemplate(FishType.Eel,"Eel", Fish.FishRarity.Rare, 90, 150, 4.5f, 6.6f, 35, 2000, Resources.Load("Images/Fish/Eel.png")as Sprite)},
        {FishType.Pufferfish, new FishTemplate(FishType.Pufferfish,"Pufferfish", Fish.FishRarity.Rare, 80, 120, 1.6f, 2.2f, 45, 9000, Resources.Load("Images/Fish/Pufferfish.png")as Sprite)},
        {FishType.Sailfish, new FishTemplate(FishType.Sailfish,"Sailfish", Fish.FishRarity.Rare, 300, 400, 185, 225, 100, 500, Resources.Load("Images/Fish/Sailfish.png")as Sprite)},
