...
public class FishGenerator
{
    ...
    public static readonly Dictionary<FishType, FishTemplate> FishTemplates = new Dictionary<FishType, FishTemplate>{
        ...
        {FishType.KingCrab, new FishTemplate(FishType.KingCrab,"KingCrab", Fish.FishRarity.Rare, 150, 200, 1.8f, 2, 60, 6000, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.Eel, new FishTemplate(FishType.Eel,"Eel", Fish.FishRarity.Rare, 90, 150, 4.5f, 6.6f, 35, 2000, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.Pufferfish, new FishTemplate(FishType.Pufferfish,"Pufferfish", Fish.FishRarity.Rare, 80, 120, 1.6f, 2.2f, 45, 9000, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.Sailfish, new FishTemplate(FishType.Sailfish,"Sailfish", Fish.FishRarity.Rare, 300, 400, 185, 225, 100, 500, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.GreatWhiteShark, new FishTemplate(FishType.GreatWhiteShark,"GreatWhiteShark", Fish.FishRarity.Legendary, 500, 600, 1800, 2000, 250, 750, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.MantaRay, new FishTemplate(FishType.MantaRay,"MantaRay", Fish.FishRarity.Legendary, 630, 700, 900, 1000, 180, 350, Resources.Load("Images/Fish/Carp.png")as Sprite)},
        {FishType.GiantSquid, new FishTemplate(FishType.GiantSquid,"GiantSquid", Fish.FishRarity.Legendary, 900, 1000, 200, 275, 150, 700, Resources.Load("Images/Fish/Carp.png")as Sprite)},
